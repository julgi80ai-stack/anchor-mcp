...
| 구현 · Implementation | **v1.4.0** (2026-08-18) — 판정 정확성 수정, 아카이브 폴백 이탈 경로, 관측 시간축 도입(스키마 v6) · matching accuracy fixed, archive fallback made two-way, observation timeline added (schema v6). 테스트 514개 · 514 tests. CI: 3 OS × Python 3.11–3.13, license gate, benchmark gate |
