...
| 구현 · Implementation | **v1.8.0** (2026-08-18) — Tasks·서버 계약 이행: ttl 정책, 종료 보장, 앵커 단위 취소, 부하 중 캐시 히트 게이트 · Tasks/server contract honoured: ttl policy, shutdown guarantee, per-anchor cancellation, cache-hit gate under load. 테스트 609개 · 609 tests. CI: 3 OS × Python 3.11–3.13, license gate, benchmark gate |
