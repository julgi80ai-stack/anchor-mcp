...
├── docs/
│   ├── SPEC.md                기술사양서 v1.7 · technical spec (Korean)
...
| 항목 · Item | 상태 · State |
|---|---|
| 기술사양서 · Spec | v1.7 (2026-08-18) |
| 구현 · Implementation | **v1.3.0** (2026-08-18) — 판정 정확성(거짓 MISSING·형제 문단 오보고) 수정, 아카이브 폴백 이탈 경로 신설 · matching accuracy fixed (false MISSING, sibling-paragraph misreports), archive fallback made two-way. 테스트 500개 · 500 tests. CI: 3 OS × Python 3.11–3.13, license gate, benchmark gate |
