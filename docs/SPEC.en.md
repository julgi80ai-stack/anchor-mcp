...
**Technical Specification v1.12 (as of completion)**
...
│   │   └── diff.py
│   ├── store/
│   │   ├── schema.sql     # full schema for new DBs (currently v7)
