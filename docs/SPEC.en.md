...
**Technical Specification v1.13 (as of completion)**
...
| `no-prose` | zero prose units (index pages) | **None** — 0% is not a fact |
...
│   │   └── diff.py
│   ├── store/
│   │   ├── schema.sql     # full schema for new DBs (currently v8)
